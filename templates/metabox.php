...
<div class="chatpress-metabox">
    <div class="chatpress-mb-tabs">
        <button class="chatpress-tab active" data-tab="content">Contenuto</button>
        <button class="chatpress-tab" data-tab="seo">SEO</button>
    </div>
    ...
    <div class="chatpress-tab-content active" id="chatpress-tab-content">
        <div class="chatpress-mb-field">
            ...
            <input type="text" id="chatpress-keywords" />
        </div>
        <button type="button" id="chatpress-generate-content" class="button button-primary chatpress-btn-full">Genera bozza articolo</button>
        <div id="chatpress-content-result" class="chatpress-result" style="display: none">
            <div class="chatpress-result-text"></div>
            <button type="button" class="button chatpress-insert-content">Inserisci nell'editor</button>
        </div>
    </div>
    ...
    <div class="chatpress-tab-content" id="chatpress-tab-seo">
        ...
        <button type="button" id="chatpress-generate-seo" class="button button-primary chatpress-btn-full">Genera Meta SEO</button>
        <div id="chatpress-seo-result" class="chatpress-result" style="display: none">
            ...
            <div class="chatpress-seo-field">
                ...
                <button type="button" class="button chatpress-insert-excerpt">Inserisci excerpt</button>
            </div>
        </div>
    </div>
