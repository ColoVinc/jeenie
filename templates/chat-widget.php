...
<div id="chatpress-chat-widget" class="chatpress-chat-widget">
    ...
    <div id="chatpress-chat-window" class="chatpress-chat-window" style="display:none;">
        ...
        <div id="chatpress-chat-messages" class="chatpress-chat-messages">
            <div class="chatpress-chat-message chatpress-chat-message--ai">
        ...
        <div class="chatpress-chat-suggestions">
            ...
            <button class="chatpress-suggestion" data-msg="Come posso migliorare la SEO del sito?">🔍 Consigli SEO</button>
            <button class="chatpress-suggestion" data-msg="Scrivi un post breve su un argomento a mia scelta">✍️ Scrivi un post</button>
        </div>

        <div class="chatpress-chat-input-wrap">
            <textarea
                id="chatpress-chat-input"
